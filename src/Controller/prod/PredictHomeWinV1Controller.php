...
use App\Entity\PredictHomeWinProd;
use App\Entity\Team;
...
class PredictHomeWinV1Controller extends AbstractController
{
    /**
     * @Route("/prod/home-win-v1", name="home.home_win_v1_prod")
     */
...
//             * Start prediction
//             */
//            $prediction = new PredictHomeWinProd($homeTeam, $awayTeam);
//            $predictHomeWinV1 = ($prediction->predictHomeWinV1() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 1.6 ) && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" )) ? $prediction->predictHomeWinV1() : '';
//
//            if ($predictHomeWinV1)
//            {
...
//            }
        ...
        return $this->render('prod/predict_home_win_v1.html.twig', [
