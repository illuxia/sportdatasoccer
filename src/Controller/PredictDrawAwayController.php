...
class PredictDrawAwayController extends AbstractController
{
    ...
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            if (
                $prediction->predictDrawAwayV1() != '' && ($fixture['home_odds'] >= 1.65 && $fixture['home_odds'] <= 1.9 && ($fixture['handicap'] != "3" && $fixture['handicap'] != "3.0" && $fixture['handicap'] != "2.5,3.0" && $fixture['handicap'] != "2.75" && $fixture['handicap'] != "3.0,3.5" && $fixture['handicap'] != "3.25" && $fixture['handicap'] != "3.5" ))
            ...
            )
            {
                ...
                $predictDrawAwayV1 = ($prediction->predictDrawAwayV1() != '' && ($fixture['home_odds'] >= 1.65 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] != "3" && $fixture['handicap'] != "3.0" && $fixture['handicap'] != "2.5,3.0" && $fixture['handicap'] != "2.75" && $fixture['handicap'] != "3.0,3.5" && $fixture['handicap'] != "3.25" && $fixture['handicap'] != "3.5" ) ) ? $prediction->predictDrawAwayV1() : '';
