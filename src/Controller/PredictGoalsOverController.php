...
class PredictGoalsOverController extends AbstractController
{
    /**
     * @Route("/goals-over", name="home.goals-over")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            if (
                ...
                || ($prediction->predictOverV2() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 1.6 ) && ($fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" ))
                || ($prediction->predictOverV3() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 1.55 ) && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" ))
            )
            {

                $finalScore = (explode("-",$fixture['ft_score']));

                $predictOverV1 = ($prediction->predictOverV1() != '' && ($fixture['handicap'] == "2.5" )) ? $prediction->predictOverV1() : '';
                $predictOverV2 = ($prediction->predictOverV2() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 1.6 ) && ($fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" )) ? $prediction->predictOverV2() : '';
                $predictOverV3 = ($prediction->predictOverV3() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 1.55 ) && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" )) ? $prediction->predictOverV3() : '';
                ...
                array_push($predictions, [
                    ...
                    'prediction_over_V3' => $predictOverV3,
                ]);
            }
        ...
        return $this->render('predict_goals_over.html.twig', [
