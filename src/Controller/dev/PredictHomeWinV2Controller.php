...
class PredictHomeWinV2Controller extends AbstractController
{
    /**
     * @Route("/dev/home-win-v2", name="home.home_win_v2")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            if (
//                $prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.71 && $fixture['home_odds'] <= 2.1 ) && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" )
                $prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.9 && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.0,3.5" ))
            )
            {

                $finalScore = (explode("-",$fixture['ft_score']));

//                $predictHomeWinV2 = ($prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.71 && $fixture['home_odds'] <= 2.1 ) && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" ) ) ? $prediction->predictHomeWinV2() : '';
                $predictHomeWinV2 = ($prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.0,3.5")) ? $prediction->predictHomeWinV2() : '';
        ...
        return $this->render('dev/predict_home_win_v2.html.twig', [
