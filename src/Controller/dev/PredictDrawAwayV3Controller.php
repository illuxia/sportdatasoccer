...
class PredictDrawAwayV3Controller extends AbstractController
{
    /**
     * @Route("/draw-away-v3", name="home.draw_away_v3")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            if (
                $prediction->predictDrawAwayV3() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.8 && ($fixture['handicap'] != "2.5,3.0" && $fixture['handicap'] != "2.75" && $fixture['handicap'] != "3" && $fixture['handicap'] != "3.0" && $fixture['handicap'] != "3.0,3.5" && $fixture['handicap'] != "3.25" && $fixture['handicap'] != "3.5" ))
            ...
            )
            {
                ...
                $predictDrawAwayV3 = ($prediction->predictDrawAwayV3() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.8) && ($fixture['handicap'] != "2.5,3.0" && $fixture['handicap'] != "2.75" && $fixture['handicap'] != "3" && $fixture['handicap'] != "3.0" && $fixture['handicap'] != "3.0,3.5" && $fixture['handicap'] != "3.25" && $fixture['handicap'] != "3.5" )) ? $prediction->predictDrawAwayV3() : '';
        ...
        return $this->render('dev/predict_draw_away_v3.html.twig', [
