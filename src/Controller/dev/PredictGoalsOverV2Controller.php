    ...
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            )
            {
                ...
                $predictOverV2 = ($prediction->predictOverV2() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 1.6 ) && ($fixture['handicap'] == "2" || $fixture['handicap'] == "2.0" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" )) ? $prediction->predictOverV2() : '';
        ...
        return $this->render('dev/predict_goals_over_v2.html.twig', [
