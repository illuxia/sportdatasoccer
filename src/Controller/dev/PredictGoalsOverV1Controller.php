...
class PredictGoalsOverV1Controller extends AbstractController
{
    /**
     * @Route("/goals-over-v1", name="home.goals-over_v1")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            if (
                $prediction->predictOverV1() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 2.15 ) && ($fixture['handicap'] == "2.5" )
            )
            {

                $finalScore = (explode("-",$fixture['ft_score']));

                $predictOverV1 = ($prediction->predictOverV1() != '' && ($fixture['home_odds'] >= 1.2 && $fixture['home_odds'] <= 2.15 ) && ($fixture['handicap'] == "2.5" )) ? $prediction->predictOverV1() : '';
        ...
        return $this->render('dev/predict_goals_over_v1.html.twig', [
