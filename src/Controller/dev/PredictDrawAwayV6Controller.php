...
class PredictDrawAwayV6Controller extends AbstractController
{
    /**
     * @Route("/draw-away-v6", name="home.draw_away_v6")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            if (
                $prediction->predictDrawAwayV6() != '' && ($fixture['home_odds'] >= 1.55 && $fixture['home_odds'] <= 1.7 )

            )
            {
                $finalScore = (explode("-",$fixture['ft_score']));

                $predictDrawAwayV6 = ($prediction->predictDrawAwayV6() != '' && ($fixture['home_odds'] >= 1.55 && $fixture['home_odds'] <= 1.7) ) ? $prediction->predictDrawAwayV6() : '';
                ...
                array_push($predictions, [
                    ...
                    'prediction_draw_away_V6' => $predictDrawAwayV6,
                ]);
            }
        ...
        return $this->render('dev/predict_draw_away_v6.html.twig', [
