...
class PredictHomeWinV4Controller extends AbstractController
{
    /**
     * @Route("/dev/home-win-v4", name="home.home_win_v4")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
            ...
            if (
                $prediction->predictHomeWinV4() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0,3.5" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.5" )
            )
            {

                $finalScore = (explode("-",$fixture['ft_score']));

                $predictHomeWinV4 = ($prediction->predictHomeWinV4() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" || $fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0,3.5" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.5" ) ) ? $prediction->predictHomeWinV4() : '';
        ...
        return $this->render('dev/predict_home_win_v4.html.twig', [
