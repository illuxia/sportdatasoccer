...
use App\Entity\PredictGoalsUnderDev;
use App\Entity\Team;
...
class PredictGoalsUnderController extends AbstractController
{
    /**
     * @Route("/goals-under", name="home.goals-under")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
             ...
             * Start prediction
             */
            $prediction = new PredictGoalsUnderDev($homeTeam, $awayTeam);

            if (
                ($prediction->predictUnderV1() != '' && ($fixture['home_odds'] >= 2.4 && $fixture['home_odds'] <= 2.65 ) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" ))
                || ($prediction->predictUnderV2() != '' && ($fixture['home_odds'] >= 2.4 && $fixture['home_odds'] <= 2.65 ) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" ))
            )
            {

                $finalScore = (explode("-",$fixture['ft_score']));

                $predictUnderV1 = ($prediction->predictUnderV1() != '' && ($fixture['home_odds'] >= 2.4 && $fixture['home_odds'] <= 2.65 ) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" )) ? $prediction->predictUnderV1() : '';
                $predictUnderV2 = ($prediction->predictUnderV2() != '' && ($fixture['home_odds'] >= 2.4 && $fixture['home_odds'] <= 2.65 ) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" )) ? $prediction->predictUnderV2() : '';
        ...
        return $this->render('predict_goals_under.html.twig', [
