...
use App\Entity\PredictionFinal;
...
class PredictionFinalController extends AbstractController
{
    /**
     * @Route("/final", name="home.final")
     */
    public function predictions(Connection $connection)
    {
        ...
        foreach ($fixtures as $fixture)
        {
             ...
             * Start prediction
             */
            $prediction = new PredictionFinal($homeTeam, $awayTeam);
            ...
            if (
                ...
                || ($prediction->predictOverV1() != '' && $fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.95 && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" )) // X2
//                || ($prediction->predictOverV1() != '' && $fixture['home_odds'] >= 1.55 && $fixture['home_odds'] <= 1.95 && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" ))
                || ($prediction->predictOverV2() != '' && $fixture['home_odds'] >= 1.5 && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" ))
//                || ($prediction->predictHomeWinV1() != '' && ($fixture['home_odds'] > 1.65 && $fixture['home_odds'] <=1.9) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" ))
                || ($prediction->predictHomeWinV1() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <=1.9) && ($fixture['handicap'] != "3" && $fixture['handicap'] != "3.0" && $fixture['handicap'] != "2.5,3.0" && $fixture['handicap'] != "2.75" && $fixture['handicap'] != "3.0,3.5" && $fixture['handicap'] != "3.25" && $fixture['handicap'] != "3.5" ))
//                || ($prediction->predictDrawAwayV1() != '' && ($fixture['home_odds'] >= 1.65 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" ))
                || ($prediction->predictDrawAwayV1() != '' && ($fixture['home_odds'] >= 1.65 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" ) )
            )
            {
                ...
                $predictOverV1 = ($prediction->predictOverV1() != '' && $fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.95 && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" )) ? $prediction->predictOverV1() : ''; // X2
//                $predictOverV1 = ($prediction->predictOverV1() != '' && $fixture['home_odds'] >= 1.55 && $fixture['home_odds'] <= 1.95 && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" )) ? $prediction->predictOverV1() : '';
...
//                $predictHomeWinV1 = ($prediction->predictHomeWinV1() != '' && ($fixture['home_odds'] > 1.65 && $fixture['home_odds'] <=1.9) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" )) ? $prediction->predictHomeWinV1() : '';
                $predictHomeWinV1 = ($prediction->predictHomeWinV1() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <=1.9) && ($fixture['handicap'] != "3" && $fixture['handicap'] != "3.0" && $fixture['handicap'] != "2.5,3.0" && $fixture['handicap'] != "2.75" && $fixture['handicap'] != "3.0,3.5" && $fixture['handicap'] != "3.25" && $fixture['handicap'] != "3.5" )) ? $prediction->predictHomeWinV1() : '';
//                $predictDrawAwayV1 = ($prediction->predictDrawAwayV1() != '' && ($fixture['home_odds'] >= 1.65 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" )) ? $prediction->predictDrawAwayV1() : '';
                $predictDrawAwayV1 = ($prediction->predictDrawAwayV1() != '' && ($fixture['home_odds'] >= 1.65 && $fixture['home_odds'] <= 1.9) ) ? $prediction->predictDrawAwayV1() : '';
        ...
        return $this->render('prediction_final.html.twig', [
