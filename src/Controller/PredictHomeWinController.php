...
class PredictHomeWinController extends AbstractController
{
    /**
     * @Route("/home-win", name="home.home_win")
     */
...
//                $prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.9 && ($fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0,3.5" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.5" ) )
//                $prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.9 && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" ))
                || $prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.9 )
                || $prediction->predictHomeWinV3() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.9 )
                || $prediction->predictHomeWinV4() != '' && ($fixture['home_odds'] >= 1.96 && $fixture['home_odds'] <= 2.3 && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0,3.5" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.5" ))
            ...
            )
            {
                ...
                $predictHomeWinV1 = ($prediction->predictHomeWinV1() != '' && ($fixture['home_odds'] >= 1.55 && $fixture['home_odds'] <= 1.9) ) ? $prediction->predictHomeWinV1() : '';
//                $predictHomeWinV2 = ($prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0,3.5" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.5" ) ) ? $prediction->predictHomeWinV2() : '';
//                $predictHomeWinV2 = ($prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.0,2.5" || $fixture['handicap'] == "2.25" ) ) ? $prediction->predictHomeWinV2() : '';
                $predictHomeWinV2 = ($prediction->predictHomeWinV2() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.9) ) ? $prediction->predictHomeWinV2() : '';
                $predictHomeWinV3 = ($prediction->predictHomeWinV3() != '' && ($fixture['home_odds'] >= 1.7 && $fixture['home_odds'] <= 1.9) ) ? $prediction->predictHomeWinV3() : '';
                $predictHomeWinV4 = ($prediction->predictHomeWinV4() != '' && ($fixture['home_odds'] >= 1.96 && $fixture['home_odds'] <= 2.3) && ($fixture['handicap'] == "2.5" || $fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0,3.5" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.5" )) ? $prediction->predictHomeWinV4() : '';
                $predictHomeWinV5 = ($prediction->predictHomeWinV5() != '' && ($fixture['home_odds'] >= 1.6 && $fixture['home_odds'] <= 1.9) && ($fixture['handicap'] == "2.5,3.0" || $fixture['handicap'] == "2.75" || $fixture['handicap'] == "3.0" || $fixture['handicap'] == "3" || $fixture['handicap'] == "3.0,3.5" || $fixture['handicap'] == "3.25" || $fixture['handicap'] == "3.5" ) ) ? $prediction->predictHomeWinV5() : '';
                ...
                array_push($predictions, [
                    ...
                    'prediction_home_win_V2' => $predictHomeWinV2,
                    'prediction_home_win_V3' => $predictHomeWinV3,
                    'prediction_home_win_V4' => $predictHomeWinV4,
                    'prediction_home_win_V5' => $predictHomeWinV5
                ]);
            }
        ...
        return $this->render('predict_home_win.html.twig', [
